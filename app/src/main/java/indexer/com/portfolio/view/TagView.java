...
public class TagView extends EditText implements OnClickListener, AnimationListener {
  ...
  public TagView(Context context, AttributeSet attrs, int defStyle) {
    ...
    mTagBackground =
        parseColor(context, a, R.styleable.TagView_background_tag, R.color.tagBorderDefault);
    mTagBorder = parseColor(context, a, R.styleable.TagView_border, R.color.tagBackgroundDefault);
    a.recycle();
  ...
  private int parseColor(final Context context, final TypedArray a, final int index,
      final int defaultColorRes) {
